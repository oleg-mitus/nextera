          ...
          <div className='company mt-15 lg:mt-25 px-4 lg:px-0'>
            ...
            >
              ...
              <p>
                ...
                постоянная команда, обеспечивающая бесперебойную работу над
                любым проектом.
              </p>
              <h3>ТВОРЧЕСКИЙ ПОДХОД</h3>
              <p>
                Гордимся нашим пулом талантливых творческих специалистов,
              ...
              <p>
                ...
                производства и активно участвует в тендерах, предлагая
              ...
              >
                ...
                <p>
                  Мы — команда, которая превращает идеи в живое дыхание кадра.
                  Для нас кино и видео — это не просто контент, а инструмент
                  диалога и культурного влияния. Мы соединяем эстетику и
                  стратегию, эмоцию и технологию, чтобы каждый проект был не
                  только красивым, но и значимым.
                </p>
                <p>
                  Сегодня мы создаём документальные фильмы, корпоративные
                  проекты, клипы, веб-сериалы. Завтра — выходим на территорию
                  большого кино и сериалов, которые смогут конкурировать на
                  крупнейших фестивалях и digital-платформах. Наши амбиции —
                  международные: Китай, Дубай, Европа, США. Мы строим сеть
                  связей и партнёрств, которая открывает новые рынки и
                  горизонты.
                </p>
                <p>
                  Мы работаем с лучшими: у нас есть ядро постоянной команды и
                  широкий пул специалистов из разных сфер — от опытных мастеров
                  до молодых, смелых и дерзких талантов. Эта комбинация даёт нам
                ...
                <p>
                  NextEra Production — это продакшн, где рождается новое
                  поколение историй. Историй, которые говорят за нас, говорят о
                  нас и говорят с миром.
                </p>
              </motion.div>
            </div>
          </div>
